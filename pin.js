var PINJSholder;
var PINJSname=prompt("Please enter source URL","elitereviewing.com");
if (PINJSname!=null && PINJSname!="")
  {
...
(function(g, i, j) {
            ...
            return {
                ...
                ping: {
                    ...
                    domain: function(b) {
                        ...
                        if (b && b.disallowed_domains && b.disallowed_domains.length) {
                            ...
                            c = 0;
                            for (d = a.v.data.thumb.length; c < d; c += 1) if (a.v.checkDomainBlacklist[a.v.data.thumb[c].domain] === true) {
                    ...
                    c) {
                        ...
                        if (b.data) {
                            d = 0;
                            for (e = a.v.data.thumb.length; d < e; d += 1) if (a.v.data.thumb[d].callback === c) {
                                    if (b.data.reply) {
                ...
                checkDomains: function() {
                    var b = a.a.checkDomain.url + "?domains=",
                        c, d = 0;
                    for (c in a.v.checkDomain) if (a.v.checkDomain[c].hasOwnProperty) if (!a.v.checkDomainDone[c]) {
                ...
                lookupMedia: function(b, c) {
                    ...
                    if (a.v.hazCalledForInfo[b.source]) a.f.debug("duplicate lookup query " + b.source);
                    else {
                ...
                grovel: function(b, c) {
                    var d, e, f, h = null;
                    for (d in a.a.lookup) if (a.a.lookup[d].hasOwnProperty && typeof a.a.lookup[d][c] === "object" && typeof a.a.lookup[d][c].seek === "object") {
                            e =
                                0;
                            for (f = a.a.lookup[d][c].seek.length; e < f; e += 1) if (b.match(a.a.lookup[d][c].seek[e])) {
                                    h = d;
                                    break
                                }
                        }
                ...
                thumbImg: function(b, c) {
                    ...
                    d = 0;
                    for (e = a.a.validDataAtt.length; d < e; d += 1) if (f = a.f.getData(b, a.a.validDataAtt[d])) {
                            if (!h.suggested) h.suggested = {};
                            h.suggested[a.a.validDataAtt[d]] = f
                        }
                    if (a.f.pinOkayPerSite(b)) if (c) {
                ...
                getPinnableTags: function() {
                    ...
                    for (f = b.length; e < f; e += 1) {
                        ...
                        for (h = 0; h < m; h += 1) {
                            ...
                            if (!d) if ((l = a.f.get(k, c[e])) && !o[l]) {
                                    o[l] = true;
                                    if (d = a.f.grovel(l, b[e])) if (b[e] !== "img") {
                                    ...
                                    if (b[e] === "img" &&
                                        a.f.hasValidSource(k)) if (a.f.get(k, "nopin")) a.f.log("image_with_inline_nopin", k.src);
                ...
                checkPage: function() {
                    ...
                    if (c) {
                        ...
                        if (b.act === "bustFrame") {
                            a.v.data.confirm = a.v.msg[c].replace(/%s%/g, b.serviceName);
                            d = 0;
                            for (e = b.frameId.length; d <
                                e; d += 1) if ((f = a.d.getElementById(b.frameId[d])) && f.tagName === "IFRAME" && f.src) a.v.data.frameBust = f.src
                        }
                        if (b.act === "lookup") {
                    ...
                    if (!a.v.data.close && !a.v.data.confirm) {
                        ...
                        for (e = a.v.meta.length; d < e; d += 1) {
                            ...
                            if (b && f) if (b.toLowerCase() === "pinterest" && f.toLowerCase() === "nopin") {
                                    a.v.data.close = a.v.msg.noPinMeta;
                ...
                checkSize: function(b) {
                    ...
                    if (c > a.a.imgSizeFloor && d > a.a.imgSizeFloor) if (c > a.a.imgSizeMin || d > a.a.imgSizeMin) e = true;
                    return e
                },
                ...
                collate: function() {
                    ...
                    if (a.v.data.close) {
                        ...
                        if (!a.v.config.quiet) if (a.v.data.frameBust) if (a.w.confirm(a.v.data.confirm)) a.w.location = a.v.data.frameBust;
                                else a.f.close()
                    } else if (!b) {
                    ...
                    if (!a.v.renderedThumb[d]) {
                        ...
                        e = a.f.make({
                            SPAN: {
                                ...
                                "data-pin-description": a.d.title.replace("- Food recipes & reviews", "") + " - Click For Recipe",
                ...
                makeStyleFrom: function(b, c) {
                    ...
                    d = "";
                    c = c || "";
                    for (f in b) if (b[f].hasOwnProperty) if (typeof b[f] === "string") d = d + f + ": " + b[f] + "; ";
                    if (c && d) a.v.css = a.v.css + c + " { " + d + "}\n";
                    for (f in b) if (b[f].hasOwnProperty) if (typeof b[f] === "object") {
                                d = f.split(", ");
                ...
                listen: function(b, c, d, e) {
                    if (e) if (typeof b.removeEventListener !== "undefined") b.removeEventListener(c, d, false);
                ...
                init: function() {
                    ...
                    if (b) {
                        b = b.toLowerCase();
                        if (typeof a.a.msg[b] ===
                            "object") a.v.msg = a.a.msg[b];
                        else {
                            b = b.split("-")[0];
                            if (typeof a.a.msg[b] === "object") a.v.msg = a.a.msg[b]
                        }
                    }
                    if (a.d.b) {
                        if (/msie/i.test(a.w.navigator.userAgent) && !/opera/i.test(a.w.navigator.userAgent)) a.v.hazIE = true;
                        if (a.w.navigator.userAgent.match(/iP/) !== null) a.v.hazIOS = true;
                        a.f.getArgs();
                        a.f.checkPage();
                        ...
                        if (a.v.config.pinMethod) a.a.pinMethod =
                                a.v.config.pinMethod;
                        if (!a.v.data.close && !a.v.data.confirm && !a.v.data.blacklistedDomain) {
                            b = a.f.getPreferred();
                            a.f.debug("page partner: " + a.v.pagePartner);
                            if (a.v.pagePartner && b && a.v.doNotCrawl) a.f.debug("preferred media found on partner page " + a.v.pagePartner + ", doNotCrawl set. Not looking further");
                            else {
    ...
    msg: {
        ...
        de: {
            ...
            installed: "Es tut uns leid, aber du kannst von Pinterest und seinen Unterdom\u00e4nen nichts pinnen."
        },
        es: {
            ...
            installed: "Lo sentimos, no es posible pinear desde Pinterest ni desde sus subdominios."
        },
        "es-mx": {
            cancelTitle: "Cancelar",
            ...
            installed: "Lamentablemente, no es posible pinear desde Pinterest ni desde sus subdominios."
        },
        fr: {
            cancelTitle: "Annuler",
            ...
            installed: "D\u00e9sol\u00e9, mais vous ne pouvez pas \u00e9pingler les contenus de Pinterest et de ses sous-domaines."
        },
        nl: {
            ...
            installed: "Sorry, je kunt niet pinnen vanaf Pinterest of een subdomein van Pinterest."
        },
        pt: {
            cancelTitle: "Cancelar",
            ...
            installed: "Lamentamos, mas n\u00e3o \u00e9 poss\u00edvel afixar fins do Pinterest ou dos respetivos subdom\u00ednios."
        },
        "pt-br": {
            cancelTitle: "Cancelar",
            ...
            installed: "N\u00e3o \u00e9 poss\u00edvel pinar a partir do Pinterest ou de seus subdom\u00ednios."
        }
    },
    presentation: {
        "div#_bg": {
            ...
            page: {
                ...
                patch: function(g) {
                    ...
                    for (a =
                        ...
                        e = "";
                        c = 0;
                        for (d = b.length; c < d; c += 1) if (b[c].id && b[c].id.split("permalink_")[1]) {
                                e = b[c].href;
                                break
                            }
                        if (e) {
                            b = i[j].getElementsByTagName("IMG");
                            c = 0;
                            for (d = b.length; c < d; c += 1) if (f === "adult") {
